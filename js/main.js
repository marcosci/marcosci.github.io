...
var header = document.getElementById('typedheader');
var subheader = document.getElementById('typedsubheader');
...
let header1 = "Programming.";
let header2 = "Frontend.";
let header3 = "Data Science.";
let header4 = "Geocompuation."
let header5 = "Visualisiation."

let subHeader1 = "R, Python, C++, Javascript, NetLogo, SQL.";
let subHeader2 = "Shiny, Dash, Tableau.";
let subHeader3 = "ML, Spatial Statistics, Point Pattern Analysis, Agent Based Modelling.";
let subHeader4 = "sf, terra, geopandas, gdal, GrassGIS, Earth Engine.";
let subHeader5 = "ggplot2, D3, gganimate.";
